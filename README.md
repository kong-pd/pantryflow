...
The design notes, diagrams and final screenshots are inside `docs/`. The complete Word answer sheet is kept as a separate submission artifact, because the repository is mainly for source and supporting evidence.
